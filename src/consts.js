...
module.exports = {
    TELETEXT_COLOR_BLACK, TELETEXT_COLOR_RED, TELETEXT_COLOR_GREEN, TELETEXT_COLOR_YELLOW, TELETEXT_COLOR_BLUE,
    TELETEXT_COLOR_MAGENTA, TELETEXT_COLOR_CYAN, TELETEXT_COLOR_WHITE, TELETEXT_EMPTY_CHARACTER,
    TELETEXT_CHARACTER_HEIGHT, TELETEXT_CHARACTER_WIDTH, NUMBER_OF_PNG_CHANNELS, 
    PNG_CHANNEL_RED, PNG_CHANNEL_GREEN, PNG_CHANNEL_BLUE, PNG_CHANNEL_ALPHA
}
